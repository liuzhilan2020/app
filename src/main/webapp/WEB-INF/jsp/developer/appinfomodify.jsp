...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="addinfomodifysave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <!--判断是logoFile这个显示还是uploadfile显示，通过js判断，判断的取值logoPicPath，删除以后logoPicPath的值会清空 ，空则显示uploadfile，如果 logoPicPath有值，则显示logoFile-->
          </div>
