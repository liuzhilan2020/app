...
<!-- <!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">删除掉"-//W3C//DTD HTML 4.01 Transitional//EN"页面就会变得美观很多 -->
<!DOCTYPE HTML>
<html>
  <head>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="sidebar-footer hidden-small">
              ...
              href="${pageContext.request.contextPath }/dev/loginout">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="${pageContext.request.contextPath }/dev/loginout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
